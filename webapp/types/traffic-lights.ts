...
export const PRIORITY_INFO: Record<PriorityCategory, { name: string; color: string; icon: string; svgPath: string }> = {
  ...
  public_transport: {
    ...
    color: '#2563eb',
    icon: '🚋',
    // Tram icon - rectangular body with windows and wheels
    svgPath: 'M18 10V6a2 2 0 00-2-2H8a2 2 0 00-2 2v4M18 10v7a2 2 0 01-2 2H8a2 2 0 01-2-2v-7M18 10H6M9 21v-2M15 21v-2M12 4V2M8 14h.01M16 14h.01M10 10V7M14 10V7'
  },
  logistics: {
    name: 'Vrachtverkeer',
    color: '#16a34a',
